...
const AddUser = ({ sidebar, setSidebar }) => {
                            ...
                            <form action="" className="p-5" onSubmit={submit} >
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3">
                                    ...
                                    <div className="my-2">
                                        ...
                                        <input type="password" onChange={handleChange} value={users.password} name="password" id="" className="rounded w-full my-3 px-2 py-1 text-md outline-blue-500 border" />
                                    </div>
                                </div>
