                ...
                <div className="pt-7">
                    ...
                    <ul className="mt-5">
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
                            ...
                            <span className="text-xl ml-3 text-white">Dashboard</span>
                        </li>
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
                            ...
                            <span className="text-xl ml-3 text-white">Category</span>
                        </li>
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
                            ...
                            <span className="text-xl ml-3 text-white">User</span>
                        </li>
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
                            ...
                            <span className="text-xl ml-3 text-white">Logout</span>
                        </li>
                    </ul>
                </div>
            </div>
