...
const Sidebar = ({ sidebar }) => {
    ...
    return (
        <div>
            <div className={`absolute left-0 md:flex ${sidebar ? 'block' : 'hidden'} h-screen top-0 md:w-52 w-52 bg-purple-500  transition-all`}>
                <div className="pt-7">
                    <div className="mx-5">
                    ...
                    <ul className="mt-5">
                        ...
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
                            ...
                            <Link href='/admins/user'><a><span className="text-md ml-3 text-white">User</span></a></Link>
                        </li>
                        <li className="flex bg-purple-600 items-center py-2 px-4 my-3 rounded cursor-pointer hover:bg-purple-700 transition mx-2">
